...
class Clubes extends React.Component {
    ...
    <div className="container">
       <div className="row p-4">
         ...
         <div className="col-md-4">
           <div className="card mb-4">
           <img className="card-img-top img-fluid"  src={club2} alt="Club2"/>
             <div className="card-body">
                <h3>Club Almagro</h3>
        ...
        <div className="col-md-4">
           <div className="card mb-4">
           <img className="card-img-top img-fluid"  src={club3} alt="Club3"/>
             <div className="card-body">
        ...
        <div className="col-md-4">
           <div className="card mb-4">
           <img className="card-img-top img-fluid" src={club4} alt="Club4"/>
             <div className="card-body">
             <h3>Club Grün</h3>
           ...
           <div className="card mb-4">
           <img className="card-img-top img-fluid" src={club5} alt="Club5"/>
             <div className="card-body">
